...
public class Thread_hosten_senden implements Runnable {

	private boolean hat_verbindung = false;
	public static final int PORT = 42069;
	private static volatile Thread_hosten_senden thread_senden;
	...
	public static Thread_hosten_senden getCommunicationSender() {

		if (thread_senden == null) {
			synchronized (Thread_hosten_senden.class) {
				if (thread_senden == null) {
					thread_senden = new Thread_hosten_senden();
				}
			}
		}
